  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">BlueBit </a></h1>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            ...
            <h4 class="title"><a href="<?= base_url()?>assets/">Lorem Ipsum</a></h4>
            <p class="description">Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident</p>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-bookmarks-outline"></i></div>
            <h4 class="title"><a href="<?= base_url()?>assets/">Dolor Sitema</a></h4>
            <p class="description">Minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat tarad limino ata</p>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-paper-outline"></i></div>
            <h4 class="title"><a href="<?= base_url()?>assets/">Sed ut perspiciatis</a></h4>
            <p class="description">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur</p>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-speedometer-outline"></i></div>
            <h4 class="title"><a href="<?= base_url()?>assets/">Magni Dolores</a></h4>
            <p class="description">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-barcode-outline"></i></div>
            <h4 class="title"><a href="<?= base_url()?>assets/">Nemo Enim</a></h4>
            <p class="description">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque</p>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-people-outline"></i></div>
            <h4 class="title"><a href="<?= base_url()?>assets/">Eiusmod Tempor</a></h4>
              ...
              <div class="member-info">
                <div class="member-info-content">
                  ...
                  <div class="social">
                    ...
                    <a href="<?= base_url()?>assets/"><i class="fa fa-google-plus"></i></a>
                    <a href="<?= base_url()?>assets/"><i class="fa fa-linkedin"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="<?= base_url()?>assets/tel:+155895548855">+1 5589 55488 55</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="<?= base_url()?>assets/mailto:info@example.com">info@example.com</a></p>
            </div>
          </div>
